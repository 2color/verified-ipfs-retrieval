...
const defaultMeta = {
  title: 'IPFS Verified Retrieval Demo',
  siteName: 'IPFS Verified Retrieval Demo',
  description:
    'Demonstrating how to do verified retrieval in the browser by fetching a CAR file from an IPFS HTTP gateway',
